...
import Metric_node5 as Metric   # ← 중요: Metric_node5로 교체
import torch
...
def make_land_mask(daily_stack):
    ...
    return (valid.sum(axis=0) > 0).astype(np.float32)
...
def main():
    print("="*70)
    print("베이스라인: ConvLSTM + Metric_node5 시각화/지표")
    print("="*70)
