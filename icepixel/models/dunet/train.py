# -*- coding: utf-8 -*-
"""
DUNet Forecaster 학습 스크립트

사용법:
    python -m models.dunet_cv.train
"""
...
from models.dunet.model import create_dunet_model
...
def main():
    ...
    print("=" * 80)
    print("DUNet Forecaster Training")
    print("=" * 80)
