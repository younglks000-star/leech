# -*- coding: utf-8 -*-
"""
SICNet-TSAM Forecaster 학습 스크립트

사용법:
    python -m models.sicnet_tsam_cv.train
"""
...
from models.sicnet_tsam.model import create_sicnet_tsam_model
...
def get_config():
    ...
    config = SimpleNamespace(
        ...
        output_lens=[7, 14, 21],
        # 모델
        model_name="SICNet_TSAM_CV",
        input_size=(448, 304),
        # 학습
        batch_size=2,
        num_workers=2,
        Epoch=30,
        lr=1e-4,      # TSAM 조금 복잡하니까 1e-4 정도로 시작
        use_amp=True,
        # 기타
...
def main():
    ...
    print("=" * 80)
    print("SICNet-TSAM Forecaster Training")
    print("=" * 80)
    ...
    for seq_output in config.output_lens:
        ...
        # 2) Model
        print("\n[2] Creating Model...")
        model = create_sicnet_tsam_model(
