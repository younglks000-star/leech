# -*- coding: utf-8 -*-
"""
NUNet Forecaster 학습 스크립트

사용법:
    python -m models.nunet_cv.train
"""
...
from models.nunet.model import create_nunet_model
...
def main():
    ...
    print("=" * 80)
    print("NUNet Forecaster Training")
    print("=" * 80)
        ...
        for epoch in range(config.Epoch):
            ...
            if sample and (epoch % config.plot_interval == 0 or epoch == config.Epoch - 1):
                ...
                plot_spatial_comparison(
                    sample["pred"][-1, 0],
                    sample["true"][-1, 0],
                    date=sample.get("date") or train_dataset.file_list[0][0],
